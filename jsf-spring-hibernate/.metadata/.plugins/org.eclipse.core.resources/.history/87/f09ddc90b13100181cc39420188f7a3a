package com.dpbygauri.primefaces.view;
...
import com.dpbygauri.primefaces.repository.DepartmentRepository;
import com.dpbygauri.primefaces.repository.EmployeeRepository;
